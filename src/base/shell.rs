...
pub static ROOT_MENU: Menu<AsyncMenuBuf, AppState> = Menu {
    ...
    items: &[
        ...
        &Item {
            command: "ssh",
            help: Some("Connect to a remote host using SSH"),
            item_type: ItemType::Callback {
                function: help_callback,
                parameters: &[
                    Parameter::Mandatory {
                        parameter_name: "host",
                        help: Some("IP to connect to."),
                    },
                    Parameter::Optional {
                        parameter_name: "port",
                        help: Some("Port to connect to. (default: 2222)"),
                    },
                    Parameter::Optional {
                        parameter_name: "user",
                        help: Some("Username to connect to on the rmeote machine. (default: device SSH_USER in .env file)"),
                    },           
                ],
            },
        },
