...
pub const GALLERY_PNG: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/apps/gallery/images-bold.png"
));

pub const GALLERY_INFO_PNG: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/apps/gallery/info-bold.png"
));


pub const DUCKTV_MUSIC_PNG: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/apps/duck-tv/music.png"
));

pub const DUCKTV_MOVIES_PNG: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/apps/duck-tv/movies.png"
));

pub const DUCKTV_TV_PNG: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/apps/duck-tv/tv.png"
));
